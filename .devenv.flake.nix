{
  ...
  version = "1.11.1";
  system = "x86_64-linux";
  devenv_root = "/home/josh/Work/prefactor/python-sdk";
  project_input_ref = "path:/home/josh/Work/prefactor/python-sdk";
  devenv_dotfile = "/home/josh/Work/prefactor/python-sdk/.devenv";
  devenv_dotfile_path = ./.devenv;
  devenv_tmpdir = "/run/user/1000";
  devenv_runtime = "/run/user/1000/devenv-945077e";
  devenv_istesting = false;
  devenv_direnvrc_latest_version = 1;
  container_name = null;
  active_profiles = [
  ];
  hostname = "fw13-prefactor";
  username = "josh";
  git_root = "/home/josh/Work/prefactor/python-sdk";
  secretspec = null;
};
    in
    {
